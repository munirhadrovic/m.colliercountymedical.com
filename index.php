...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Collier County Medical</title>
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            <li>
            	<span>Image 01</span>
            		<div>
            			<h3><img src="css/botox.png" width="100%" ></h3>
            		</div>
            </li>
            <li><span>Image 02</span><div><h3>Dermal Filler</h3></div></li>
            <li><span>Image 03</span><div><h3>Laser</h3></div></li>
            <li><span>Image 04</span><div><h3><img src="css/botox.png" width="100%" ></h3></div></li>
            <li><span>Image 05</span><div><h3>Dermal Filler</h3></div></li>
            <li><span>Image 06</span><div><h3><img src="css/botox.png" width="100%" ></h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>Collier County Medical</span></h1>
